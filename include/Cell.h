...
public:
  ...
  int GetCellSizeXY() const noexcept { return cell_size[0] * cell_size[1]; }
  ...
  Vec3 GetCellLength() const noexcept { return cell_length; }
  ...
  void CreateCell(const Vec3& Cell_Size_Ratio, const Vec3& Domain,
  ...
  void SetPeriodicEffect(const Vec3& Domain,
  ...
  void SetPeriodicEffect2DXY(const double DomainX,
                             const double DomainY) noexcept;

  void SetPeriodicEffect2DXZ(const double DomainX,
                             const double DomainZ) noexcept;

  void SetPeriodicEffect2DYZ(const double DomainY,
                             const double DomainZ) noexcept;

  void SetPeriodicEffect3D(const double DomainX, const double DomainY,
                           const double DomainZ) noexcept;
