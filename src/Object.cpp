...
{
  for (auto& o : floor_base)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
  for (auto& o : field_base)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
  for (auto& o : boundary_base)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
  for (auto& o : box)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
  for (auto& o : hollow_box)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
  for (auto& o : cylinder)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
  for (auto& o : hollow_cylinder)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
  for (auto& o : sphere)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
  for (auto& o : hollow_sphere)
    if (o.isVibOn()) o.SetHStepVelo(Elapsed_Time);
}
...
{
  for (auto& o : floor_base)
    if (o.isVibOn()) o.SetPostVelo(Elapsed_Time);
  for (auto& o : field_base)
    if (o.isVibOn()) o.SetPostVelo(Elapsed_Time);
  for (auto& o : boundary_base)
    if (o.isVibOn()) o.SetPostVelo(Elapsed_Time);
...
{
  for (auto& o : floor_base)
    if (o.isVibOn()) o.SetPostPos(Elapsed_Time);
  for (auto& o : field_base)
    if (o.isVibOn()) o.SetPostPos(Elapsed_Time);
  for (auto& o : boundary_base)
    if (o.isVibOn()) o.SetPostPos(Elapsed_Time);
                       ...
                       const std::vector<std::string>& Obj_Info) noexcept
{
  ...
  if (Obj_Type == "Boundary_Base")
  {
    ...
    {
      data_io.ErrorInput("Boundary_Base");
    }
  }
  ...
  if (Obj_Type == "Hollow_Cylinder")
  {
    ...
    {
      data_io.ErrorInput("Hollow_Cylinder");
    }
  }
  ...
  if (Obj_Type == "Hollow_Sphere")
  {
    ...
    {
      data_io.ErrorInput("Hollow_Sphere");
    }
  }
}
                             ...
                             const std::vector<std::string>& Obj_Info) noexcept
{
  for (const auto& i : Obj_Info)
  {
    ...
    if (key[0] == "Outer_Radius")
    {
      if (key_size == 2)
      {
        Parameter["outer_radius"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Outer_Radius");
      }
    }
    ...
    if (key[0] == "Inner_Radius")
    {
      if (key_size == 2)
      {
        Parameter["inner_radius"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Inner_Radius");
      }
    }
    ...
    if (key[0] == "Length")
    {
      if (key_size == 2)
      {
        Parameter["length"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Length");
      }
    }
    ...
    if (key[0] == "Thickness")
    {
      if (key_size == 2)
      {
        Parameter["thickness"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Thickness");
      }
    }
    ...
    if (key[0] == "Direction_Unit_Vector")
    {
      ...
      {
        data_io.ErrorInput("Direction_Unit_Vector");
      }
    }
    ...
    if (key[0] == "Collision_On")
    {
      if (key_size == 2)
      {
        Parameter["collision_on"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Collision_On");
      }
    }
    ...
    if (key[0] == "Vibration_On")
    {
      if (key_size == 2)
      {
        Parameter["vibration_on"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Vibration_On");
      }
    }
    ...
    if (key[0] == "Visualization_On")
    {
      if (key_size == 2)
      {
        Parameter["visualization_on"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Visualization_On");
      }
    }
    ...
    if (key[0] == "Vibration_Frequency")
    {
      if (key_size == 2)
      {
        Parameter["frequency"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Vibration_Frequency");
      }
    }
    ...
    if (key[0] == "Vibration_Amplitude")
    {
      if (key_size == 2)
      {
        Parameter["amplitude"] = key[1];
      }
      else
      {
        data_io.ErrorInput("Vibration_Amplitude");
      }
    }
    ...
    if (key[0] == "Vibration_Unit_Vector")
    {
      ...
      {
        data_io.ErrorInput("Vibration_Unit_Vector");
      }
    }
  }
}
