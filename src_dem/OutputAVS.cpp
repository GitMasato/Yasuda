...
namespace dem
{
	...
	void OutputAVS::CreateAVS(const int Step, const Vec3& Gravity, const Vec3& Domain,
		const std::string& Avs_File, const std::string& Key) noexcept
	{
		...
		if (Key == "ch") WritePtclCharge(fout);
		else if (Key == "fo") WritePtclForce(fout, Gravity);
		else if (Key == "no") WritePtcl(fout);
		WriteObj(fout, Domain);
		fout.close();		
	}


	void OutputAVS::WriteAVS(const double Time, const Vec3& Gravity, const Vec3& Domain,
		const std::string& Avs_File, const std::string& Key) noexcept
	{
		std::ofstream fout;
	...
	void OutputAVS::WritePtclForce(std::ofstream& Fout, const Vec3& Gravity) const noexcept
	{
		...
		{	
			...
			{ adhesion, coulomb_ptcl, coulomb_ext, diele, gravity, magnetic, image, no_force };
			...
			const auto max = std::max_element(force_magnitude.begin(), force_magnitude.end());
			const int num = static_cast<int>(std::distance(force_magnitude.begin(), max));			
	...
	void OutputAVS::WriteFloor(std::ofstream& Fout, const Vec3& Domain) const noexcept
	{
		...
		Fout << o_pos.x << " " << o_pos.y << " " << o_pos.z << " "
			<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
		Fout << o_pos.x + Domain.x << " " << o_pos.y << " " << o_pos.z
			<< " " << rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
		Fout << o_pos.x + Domain.x << " " << o_pos.y + Domain.y
			<< " " << o_pos.z << " " << rgb.x
			<< " " << rgb.y << " " << rgb.z << " " << std::endl;
		Fout << o_pos.x << " " << o_pos.y + Domain.y << " " << o_pos.z
			<< " " << rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;

		Fout << "4" << std::endl;
		Fout << o_pos.x << " " << o_pos.y << " " << o_pos.z << " "
			<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
		Fout << o_pos.x << " " << o_pos.y << " " << o_pos.z - t << " "
			<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
	...
	void OutputAVS::WriteBox(std::ofstream& Fout) const noexcept
	{
		...
		for (const auto& v : o)
		{
			...
			Fout << o_pos_1.x << " " << o_pos_1.y << " " << o_pos_1.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			Fout << o_pos_2.x << " " << o_pos_1.y << " " << o_pos_1.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			Fout << o_pos_2.x << " " << o_pos_2.y << " " << o_pos_1.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			Fout << o_pos_1.x << " " << o_pos_2.y << " " << o_pos_1.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			...
			Fout << o_pos_2.x << " " << o_pos_1.y << " " << o_pos_1.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			Fout << o_pos_2.x << " " << o_pos_1.y << " " << o_pos_2.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			Fout << o_pos_1.x << " " << o_pos_1.y << " " << o_pos_2.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			...
			Fout << o_pos_1.x << " " << o_pos_2.y << " " << o_pos_1.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			Fout << o_pos_1.x << " " << o_pos_2.y << " " << o_pos_2.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
			Fout << o_pos_1.x << " " << o_pos_1.y << " " << o_pos_2.z << " "
				<< rgb.x << " " << rgb.y << " " << rgb.z << " " << std::endl;
	...
	void OutputAVS::WriteHollowCylinder(std::ofstream& Fout) const noexcept
	{
		...
		{	
			...
			for (int i = 1; i <= division_num; ++i)
			{
				...
				Fout << "4" << std::endl;
				Fout << pos_1.x << " " << pos_1.y << " " << pos_1.z << " "
					<< rgb_1.x << " " << rgb_1.y << " " << rgb_1.z << " " << std::endl;
				Fout << pos_2.x << " " << pos_2.y << " " << pos_2.z << " "
					<< rgb_1.x << " " << rgb_1.y << " " << rgb_1.z << " " << std::endl;
				Fout << pos_3.x << " " << pos_3.y << " " << pos_3.z << " "
					<< rgb_1.x << " " << rgb_1.y << " " << rgb_1.z << " " << std::endl;
				Fout << pos_4.x << " " << pos_4.y << " " << pos_4.z << " "
					<< rgb_1.x << " " << rgb_1.y << " " << rgb_1.z << " " << std::endl;
			...
			Fout << o_pos_1.x << " " << o_pos_1.y << " " << o_pos_1.z << " "
				...
				<< o_inner_R << " " << rgb_2.x << " " << rgb_2.y << " " << rgb_2.z << std::endl;
			Fout << o_pos_1.x << " " << o_pos_1.y << " " << o_pos_1.z << " "
				<< o_dir_u_vec.x << " " << o_dir_u_vec.y << " " << o_dir_u_vec.z << " "
				<< o_outer_R << " " << rgb_2.x << " " << rgb_2.y << " " << rgb_2.z << std::endl;
